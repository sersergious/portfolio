...
export function About() {
    ...
    const researchInterests = [
        ...
        {
            title: 'Mathematics',
            description: 'Applied mathematics, especially in computational contexts like algorithms and optimizations',
            icon: Target,
                        ...
                        <FadeInWhenVisible direction="up">
                            <div className="text-center mb-12">
                                ...
                                <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                                    I'm an aspiring developer and researcher on a mission to bridge
                    ...
                    <StaggerContainer className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
                        <StaggerItem>
                            <div className="text-center p-6 bg-card border border-border rounded-lg">
                                ...
                                <p className="text-sm text-muted-foreground">Awarded with a Gold Medal </p>
                            </div>
                        </StaggerItem>
                ...
                <div className="container mx-auto px-4">
                    <FadeInWhenVisible direction="up">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                                My goal is to pursue a PhD at the intersection of applied mathematics and computer science,
