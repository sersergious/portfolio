          ...
          <div className="flex flex-1 items-end p-1">
            ...
            <div className="flex-1 flex items-end px-4 py-3">
              <textarea
                ...
                rows={1}
                className="w-full resize-none border-0 bg-transparent text-[15px] text-foreground placeholder:text-muted-foreground/60 outline-none focus:outline-none min-h-[24px] max-h-[200px] overflow-y-auto leading-6"
                style={{
                  scrollbarWidth: "none",
